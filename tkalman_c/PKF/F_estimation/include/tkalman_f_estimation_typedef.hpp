#ifndef _TKALMAN_F_ESTIMATION_TYPEDEF_HPP_
#define _TKALMAN_F_ESTIMATION_TYPEDEF_HPP_
...
namespace f_estimation
{
	...
	/**@typedef int (*tkalman :: f_estimation ::estimation_function) (	gsl_matrix * f_i,
	 ...
	 **/
	typedef void (*estimation_function) (	gsl_matrix * f_i,
											const gsl_matrix * sqrt_c_i_view_00,
											const gsl_matrix * sqrt_c_i_view_01,
											const void * estimator,
	...
	{
		public:
			/**@fn tkalman :: f_estimation :: function_set :: function_set(	allocation_function estimator_allocation_function,
